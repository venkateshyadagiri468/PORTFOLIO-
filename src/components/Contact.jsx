    ...
    <section id="contact" className="py-24 px-6 md:px-12 max-w-7xl mx-auto relative z-10">
      ...
      <div className="flex flex-col gap-3 mb-16 text-center max-w-3xl mx-auto">
        <span className="text-xs font-mono uppercase tracking-widest text-cyan-400 font-bold flex items-center justify-center gap-2">
          <MessageSquare className="w-4 h-4 text-indigo-400" /> Get In Touch
        </span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
        ...
        <div className="lg:col-span-5 flex flex-col gap-6 justify-between">
          <div className="glass-panel p-8 rounded-3xl border border-indigo-500/20 glass-panel-hover flex flex-col gap-6">
            <h3 className="text-2xl font-bold text-white flex items-center gap-2">
              Contact Details <Sparkles className="w-5 h-5 text-cyan-400" />
            </h3>
            ...
            <div className="flex flex-col gap-4 pt-2">
              ...
              >
                ...
                <div className="flex flex-col">
                  <span className="text-[10px] font-mono text-slate-500 uppercase tracking-wider">Phone / WhatsApp</span>
                  <span className="text-sm font-semibold text-white group-hover:text-cyan-300 transition-colors">
                    +91 7702920468
                  </span>
                </div>
              ...
              <div className="flex items-center gap-4 p-4 rounded-2xl bg-slate-900/80 border border-slate-800">
                ...
                <div className="flex flex-col">
                  <span className="text-[10px] font-mono text-slate-500 uppercase tracking-wider">Base Location</span>
          ...
          <div className="glass-panel p-6 rounded-3xl border border-indigo-500/20 bg-gradient-to-r from-indigo-950/40 to-slate-900/40 flex items-center gap-3">
        ...
        <div className="lg:col-span-7 glass-panel p-8 rounded-3xl border border-indigo-500/20 flex flex-col justify-between">
          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-2">
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-xl bg-slate-900/90 border border-slate-800 text-white placeholder-slate-600 focus:outline-none focus:border-indigo-500 text-sm transition-colors"
              />
            </div>
            ...
            {/* Message */}
            <div className="flex flex-col gap-2">
              <label className="text-xs font-mono text-slate-300 uppercase tracking-wider">Message / Inquiry</label>
              <textarea
                required
                rows={4}
                ...
                className="w-full px-4 py-3 rounded-xl bg-slate-900/90 border border-slate-800 text-white placeholder-slate-600 focus:outline-none focus:border-indigo-500 text-sm transition-colors resize-none"
              />
            </div>
            ...
            <button
              ...
              className={`w-full py-4 rounded-xl font-bold text-sm flex items-center justify-center gap-2 transition-all duration-300 shadow-xl ${
                status === 'success'
